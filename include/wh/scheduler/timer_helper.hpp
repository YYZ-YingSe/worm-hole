...
concept timed_scheduler_like =
    exec::timed_scheduler<remove_cvref_t<scheduler_t>>;
...
[[nodiscard]] constexpr auto schedule_after(const scheduler_t &scheduler,
                                            duration_t &&duration) {
...
[[nodiscard]] constexpr auto schedule_at(const scheduler_t &scheduler,
                                         deadline_t &&deadline) {
