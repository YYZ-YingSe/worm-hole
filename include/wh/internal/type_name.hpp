...
template <typename t> [[nodiscard]] constexpr std::string_view stable_type_name() noexcept {
...
/// name).
template <typename t> [[nodiscard]] constexpr std::string_view diagnostic_type_alias() noexcept {
  using normalized_t = detail::remove_cvref_t<t>;
...
template <typename t> [[nodiscard]] constexpr std::string_view persistent_type_alias() noexcept {
  using normalized_t = detail::remove_cvref_t<t>;
...
template <typename t> [[nodiscard]] constexpr std::uint64_t stable_type_hash() noexcept {
  return stable_name_hash(diagnostic_type_alias<t>());
}

/// Hashes persistent type alias.
template <typename t> [[nodiscard]] constexpr std::uint64_t persistent_type_hash() noexcept {
