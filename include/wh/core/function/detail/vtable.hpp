...
#define WH_DEFINE_VTABLE_HANDLER(CV, REF, INV_QUALS)                                               \
  ...
  private:                                                                                         \
    using manager_t =                                                                              \
        object_manager<invocable_t, ownership_policy, check_none_base, buffer_size, allocator_t>;  \
    manager_t manager_;                                                                            \
    template <typename type_t> [[nodiscard]] static consteval auto basic_constraint() -> bool {    \
  ...
  public:                                                                                          \
    ...
    static constexpr bool is_constructible =                                                       \
        basic_constraint<args_t...>() && manager_t::template is_constructible<args_t...>;          \
    template <typename... args_t>                                                                  \
    static constexpr bool is_nothrow_constructible =                                               \
        is_constructible<args_t...> && manager_t::template is_nothrow_constructible<args_t...>;    \
    template <typename... args_t>                                                                  \
