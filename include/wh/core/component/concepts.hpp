...
concept component_descriptor_provider =
    requires(const remove_cvref_t<component_t> &component) {
...
concept invokable_component = requires(
    component_t component, const request_t &request, run_context &context) {
...
concept streamable_component = requires(
    component_t component, const request_t &request, run_context &context) {
