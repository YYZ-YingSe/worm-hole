...
using agent_event_stream_reader = wh::schema::stream::any_stream_reader<agent_event>;

/// Type-erased writer used by ADK event streams.
using agent_event_stream_writer = wh::schema::stream::any_stream_writer<agent_event>;
...
using agent_event_stream_result = wh::schema::stream::stream_result<agent_event_stream_chunk>;
...
[[nodiscard]] inline auto try_read_agent_event_stream(agent_event_stream_reader &reader)
  ...
  if (auto *result = std::get_if<agent_event_stream_result>(&next_chunk);
      result != nullptr && result->has_error() && result->error() == wh::core::errc::not_found) {
...
[[nodiscard]] inline auto close_agent_event_stream(agent_event_stream_reader &reader)
    -> wh::core::result<void> {
...
[[nodiscard]] inline auto send_agent_event(agent_event_stream_writer &writer, agent_event &&event)
    -> wh::core::result<void> {
...
[[nodiscard]] inline auto close_agent_event_stream(agent_event_stream_writer &writer)
    -> wh::core::result<void> {
...
[[nodiscard]] inline auto make_agent_event_stream()
  ...
  auto [writer, reader] = wh::schema::stream::make_pipe_stream<agent_event>(64U);
...
inline auto send_agent_event_or_error(agent_event_stream_writer &writer, factory_t &&factory,
                                      event_metadata metadata = {}) -> wh::core::result<void> {
  try {
    return send_agent_event(writer, std::invoke(std::forward<factory_t>(factory)));
  } catch (const std::exception &error) {
    return send_agent_event(writer, make_error_event(wh::core::map_exception(error), error.what(),
                                                     {}, std::move(metadata)));
  } catch (...) {
