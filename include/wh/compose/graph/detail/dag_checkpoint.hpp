...
inline auto detail::invoke_runtime::dag_runtime::capture_checkpoint_runtime(
  ...
  auto captured =
      detail::checkpoint_runtime::capture_dag_runtime(
          session.io_storage_, dag_schedule_, frontier_,
          capture_suspended_nodes());
