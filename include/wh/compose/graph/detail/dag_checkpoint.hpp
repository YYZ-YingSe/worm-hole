// Defines DAG runtime checkpoint capture helpers.
#pragma once
...
inline auto detail::invoke_runtime::dag_runtime::capture_checkpoint_state()
...
inline auto
detail::invoke_runtime::dag_runtime::capture_checkpoint_runtime(checkpoint_runtime_state &runtime)
    -> wh::core::result<void> {
  ...
  auto captured = detail::checkpoint_runtime::capture_dag_runtime(
      session.io_storage_, dag_schedule_, frontier_, capture_suspended_nodes());
  ...
  runtime.dag = std::move(snapshot);
  return {};
}

inline auto detail::invoke_runtime::dag_runtime::try_persist_checkpoint() -> void {
  session_.request_persist_checkpoint();
}

inline auto detail::invoke_runtime::dag_runtime::make_persist_sender() -> graph_sender {
