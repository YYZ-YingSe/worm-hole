...
inline auto detail::invoke_runtime::pregel_runtime::commit_node_output(const attempt_id attempt,
...
inline auto detail::invoke_runtime::pregel_runtime::commit_skip_action(const pregel_action &action)
    -> wh::core::result<void> {
  session_.state_table_.update(action.node_id, graph_node_lifecycle_state::skipped, 0U,
                               std::nullopt);
