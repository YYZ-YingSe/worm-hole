...
TEST_CASE("internal callback manager tracks registrations and dispatch order",
  ...
  first.on_start =
      [&start_order](const wh::core::callback_stage, const wh::core::callback_event_view,
                     const wh::core::callback_run_info &) { start_order.push_back(1); };
  wh::core::stage_callbacks second{};
  second.on_start =
      [&start_order](const wh::core::callback_stage, const wh::core::callback_event_view,
                     const wh::core::callback_run_info &) { start_order.push_back(2); };
  wh::core::stage_callbacks third{};
  third.on_start =
      [&start_order](const wh::core::callback_stage, const wh::core::callback_event_view,
                     const wh::core::callback_run_info &) { start_order.push_back(3); };
  ...
  int payload = 7;
  manager.dispatch(wh::core::callback_stage::start, wh::core::make_callback_event_view(payload),
                   {});
  ...
  local_end.on_end = [&end_order](const wh::core::callback_stage,
                                  ...
                                  const wh::core::callback_run_info &) { end_order.push_back(1); };
  wh::core::stage_callbacks global_end{};
  global_end.on_end = [&end_order](const wh::core::callback_stage,
                                   const wh::core::callback_event_view,
                                   const wh::core::callback_run_info &) { end_order.push_back(2); };
  manager.register_local_callbacks(
      wh::internal::make_callback_config([](const wh::core::callback_stage stage) noexcept {
  ...
  manager.dispatch(wh::core::callback_stage::end, wh::core::make_callback_event_view(payload), {});
...
TEST_CASE("internal callback manager keeps stage registrations isolated",
  ...
  start_only.on_start = [&seen](const wh::core::callback_stage, const wh::core::callback_event_view,
                                const wh::core::callback_run_info &) { seen.push_back(1); };
  wh::core::stage_callbacks stream_end_only{};
  stream_end_only.on_stream_end =
      [&seen](const wh::core::callback_stage, const wh::core::callback_event_view,
  ...
  int payload = 3;
  manager.dispatch(wh::core::callback_stage::error, wh::core::make_callback_event_view(payload),
                   {});
  REQUIRE(seen.empty());
...
TEST_CASE("internal callback manager dispatch_single preserves typed payloads",
  ...
  manager.dispatch_single(
      ...
      [&seen](const wh::core::callback_stage, wh::core::callback_event_payload &&payload,
...
TEST_CASE("internal callback manager copy preserves snapshots and isolates "
  ...
  initial_local.on_start = [seen](const wh::core::callback_stage,
                                  const wh::core::callback_event_view,
                                  const wh::core::callback_run_info &) { seen->push_back(10); };
  ...
  copied_local.on_start = [seen](const wh::core::callback_stage,
                                 const wh::core::callback_event_view,
                                 const wh::core::callback_run_info &) { seen->push_back(20); };
  ...
  int payload = 9;
  original.dispatch(wh::core::callback_stage::start, wh::core::make_callback_event_view(payload),
                    {});
  copied.dispatch(wh::core::callback_stage::start, wh::core::make_callback_event_view(payload), {});
