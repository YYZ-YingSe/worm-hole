...
TEST_CASE("type name helpers expose explicit aliases and stable hashes",
  ...
  REQUIRE(wh::internal::stable_name_hash("abc") ==
          wh::internal::stable_name_hash("abc"));
...
TEST_CASE("type name detail helpers classify ascii digits trim spaces and suffix markers",
