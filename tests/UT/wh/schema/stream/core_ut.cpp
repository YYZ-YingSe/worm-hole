...
struct core_facade_reader {
  ...
  auto read() -> wh::schema::stream::stream_result<wh::schema::stream::stream_chunk<int>> {
    return wh::schema::stream::stream_chunk<int>::make_eof();
  }

  auto try_read() -> wh::schema::stream::stream_try_result<wh::schema::stream::stream_chunk<int>> {
...
TEST_CASE("stream core facade exposes signals chunks and borrow helpers",
  ...
  auto source_eof = wh::schema::stream::stream_chunk<int>::make_source_eof("source-a");
...
TEST_CASE("stream core facade reexports reader concepts and auto-close flags",
  ...
  STATIC_REQUIRE(!wh::schema::stream::borrowed_stream_reader<core_facade_reader>);
