...
TEST_CASE("workflow facade reexports compose workflow aliases",
  ...
  STATIC_REQUIRE(std::same_as<wh::workflow::workflow_step_ref, wh::compose::workflow::step_ref>);
  STATIC_REQUIRE(std::same_as<wh::workflow::field_mapping_rule, wh::compose::field_mapping_rule>);
  STATIC_REQUIRE(std::same_as<wh::workflow::compiled_field_mapping_rule,
                              wh::compose::compiled_field_mapping_rule>);
  STATIC_REQUIRE(
      std::same_as<wh::workflow::workflow_dependency_kind, wh::compose::workflow_dependency_kind>);
  STATIC_REQUIRE(std::same_as<wh::workflow::workflow_dependency, wh::compose::workflow_dependency>);
}
