...
static_assert(wh::core::detail::callback_filterable_request<test_request>);
static_assert(!wh::core::detail::callback_filterable_request<invalid_request>);

} // namespace

TEST_CASE("component async entry filters callback sink and runs start success error hooks only "
          "when enabled",
          "[UT][wh/core/stdexec/"
          "component_async_entry.hpp][component_async_entry][condition][branch][boundary]") {
  ...
  auto success_sender = wh::core::detail::component_async_entry<wh::core::resume_mode::unchanged>(
      test_request{.value = 7}, sink, wh::core::detail::resume_passthrough,
      [](test_request &&request) { return stdexec::just(result_t{request.value + 5}); },
      ...
      [success_probe](const wh::callbacks::callback_sink &start_sink, const callback_state &state) {
        ++success_probe->start_calls;
        success_probe->start_sink_has_value = start_sink.has_value();
        success_probe->last_phase = state.phase;
      },
      [success_probe](const wh::callbacks::callback_sink &success_sink, callback_state &state,
                      const result_t &status) {
      ...
      [success_probe](const wh::callbacks::callback_sink &error_sink, callback_state &state,
                      const result_t &status) {
  ...
  auto success = wh::testing::helper::wait_value_on_test_thread(std::move(success_sender));
  ...
  auto error_sender = wh::core::detail::component_async_entry<wh::core::resume_mode::unchanged>(
      test_request{.value = 9}, sink, wh::core::detail::resume_passthrough,
      [](test_request &&) {
        return stdexec::just(result_t::failure(wh::core::errc::invalid_argument));
      },
      ...
      [error_probe](const wh::callbacks::callback_sink &start_sink, const callback_state &state) {
        ++error_probe->start_calls;
        error_probe->start_sink_has_value = start_sink.has_value();
        error_probe->last_phase = state.phase;
      },
      [error_probe](const wh::callbacks::callback_sink &success_sink, callback_state &state,
                    const result_t &) {
        ++error_probe->success_calls;
        error_probe->success_sink_has_value = success_sink.has_value();
        error_probe->last_phase = state.phase;
      },
      [error_probe](const wh::callbacks::callback_sink &error_sink, callback_state &state,
                    const result_t &status) {
  ...
  auto error = wh::testing::helper::wait_value_on_test_thread(std::move(error_sender));
  ...
  auto disabled_sender = wh::core::detail::component_async_entry<wh::core::resume_mode::unchanged>(
      std::move(disabled_request), sink, wh::core::detail::resume_passthrough,
      [](test_request &&request) { return stdexec::just(result_t{request.value}); },
      [disabled_probe](const test_request &) {
        ++disabled_probe->make_state_calls;
        return callback_state{};
      },
      [disabled_probe](const wh::callbacks::callback_sink &, const callback_state &) {
        ++disabled_probe->start_calls;
      },
      [disabled_probe](const wh::callbacks::callback_sink &, callback_state &, const result_t &) {
  ...
  auto disabled = wh::testing::helper::wait_value_on_test_thread(std::move(disabled_sender));
...
TEST_CASE(
    "component async entry restore mode hands final completion back to provided scheduler while "
    "unchanged stays inline",
  ...
  auto unchanged_sender = wh::core::detail::component_async_entry<wh::core::resume_mode::unchanged>(
      test_request{.value = 3}, wh::callbacks::make_callback_sink(), scheduler,
      [](test_request &&request) { return stdexec::just(result_t{request.value}); },
      [](const test_request &) { return callback_state{}; },
      [](const wh::callbacks::callback_sink &, const callback_state &) {},
      [](const wh::callbacks::callback_sink &, callback_state &, const result_t &) {},
      [](const wh::callbacks::callback_sink &, callback_state &, const result_t &) {});

  auto unchanged = wh::testing::helper::wait_value_on_test_thread(std::move(unchanged_sender));
  REQUIRE(unchanged.has_value());
  REQUIRE(unchanged.value() == 3);
  REQUIRE(scheduler_state.pending_count() == 0U);

  auto restore_sender = wh::core::detail::component_async_entry<wh::core::resume_mode::restore>(
      test_request{.value = 8}, wh::callbacks::make_callback_sink(), scheduler,
      [](test_request &&request) { return stdexec::just(result_t{request.value + 1}); },
      [](const test_request &) { return callback_state{}; },
      [](const wh::callbacks::callback_sink &, const callback_state &) {},
      [](const wh::callbacks::callback_sink &, callback_state &, const result_t &) {},
      [](const wh::callbacks::callback_sink &, callback_state &, const result_t &) {});
  ...
  auto operation = stdexec::connect(
      std::move(restore_sender), wh::testing::helper::sender_capture_receiver<result_t>{&capture});
