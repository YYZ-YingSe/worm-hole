...
TEST_CASE("bounded queue critical section aliases std mutex semantics",
          "[UT][wh/core/bounded_queue/detail/critical_section.hpp][bounded_queue_critical_section][branch]") {
  STATIC_REQUIRE(std::same_as<wh::core::detail::bounded_queue_critical_section,
                              std::mutex>);
...
TEST_CASE("bounded queue critical section supports unique_lock lifecycle",
          "[UT][wh/core/bounded_queue/detail/critical_section.hpp][bounded_queue_critical_section][condition][boundary]") {
  wh::core::detail::bounded_queue_critical_section mutex{};
