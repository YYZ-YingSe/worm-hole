...
TEST_CASE("bounded_queue_status to_string covers every known enum branch and unknown fallback",
  ...
  REQUIRE(wh::core::to_string(wh::core::bounded_queue_status::closed) == "closed");
  REQUIRE(wh::core::to_string(wh::core::bounded_queue_status::busy) == "busy");
  REQUIRE(wh::core::to_string(wh::core::bounded_queue_status::busy_async) == "busy_async");
  REQUIRE(wh::core::to_string(static_cast<wh::core::bounded_queue_status>(255)) == "unknown");
}
