...
using clone_handler = wh::core::fn_detail::vtable_handler<
    int(int), adder, wh::core::fn_detail::cloneable_vtable<int(int)>,
...
using pointer_handler = wh::core::fn_detail::vtable_handler<
    int(int), std::unique_ptr<adder>,
    wh::core::fn_detail::destructible_vtable<int(int)>,
    wh::core::fn::reference_counting, sizeof(void *), true, std::allocator>;

static_assert(std::has_virtual_destructor_v<
              wh::core::fn_detail::cloneable_vtable<int(int)>>);
static_assert(std::has_virtual_destructor_v<
              wh::core::fn_detail::destructible_vtable<int(int)>>);
...
TEST_CASE("vtable base types expose the expected virtual destruction contract",
  ...
  REQUIRE(std::has_virtual_destructor_v<
          wh::core::fn_detail::cloneable_vtable<int(int)>>);
  REQUIRE(std::has_virtual_destructor_v<
          wh::core::fn_detail::destructible_vtable<int(int)>>);
}
