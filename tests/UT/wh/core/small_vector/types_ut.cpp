...
TEST_CASE("small_vector metadata helpers describe capacity growth and contract",
  ...
  REQUIRE(growth.growth_multiplier_num ==
          wh::core::small_vector_default_options::growth_numerator);
  REQUIRE(growth.growth_multiplier_den ==
          wh::core::small_vector_default_options::growth_denominator);
  REQUIRE(growth.heap_enabled ==
          wh::core::small_vector_default_options::heap_enabled);
  ...
  REQUIRE(contract.push_back_without_growth ==
          wh::core::complexity_class::constant);
}
...
TEST_CASE("small_vector option types expose configured growth knobs",
  ...
  using custom_options =
      wh::core::small_vector_options<2U, 1U, 8U, false, false, std::uint16_t>;
...
TEST_CASE("small_vector metadata helpers also describe empty-vector boundaries",
  ...
  REQUIRE(contract.push_back_with_growth ==
          wh::core::complexity_class::amortized_constant);
}
