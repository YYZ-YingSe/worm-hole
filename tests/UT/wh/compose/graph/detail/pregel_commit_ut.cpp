...
TEST_CASE("pregel commit path preserves successful node output through full graph run",
          "[UT][wh/compose/graph/detail/pregel_commit.hpp][pregel_runtime::commit_node_output][condition][branch][boundary]") {
...
TEST_CASE("pregel commit path preserves stream output through full graph run",
          "[UT][wh/compose/graph/detail/pregel_commit.hpp][pregel_runtime::commit_node_output][condition][branch][stream]") {
...
TEST_CASE("pregel commit path surfaces canceled when post-node interrupt hook fires",
          "[UT][wh/compose/graph/detail/pregel_commit.hpp][pregel_runtime::commit_node_output][condition][branch][error]") {
  auto graph = wh::testing::helper::make_runtime_identity_graph(
...
TEST_CASE("pregel commit path propagates post-node interrupt hook failure",
          "[UT][wh/compose/graph/detail/pregel_commit.hpp][pregel_runtime::commit_node_output][condition][branch][boundary][error]") {
  auto graph = wh::testing::helper::make_runtime_identity_graph(
