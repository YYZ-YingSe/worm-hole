...
TEST_CASE("dag pending-input capture emits unit completion for launch set",
          "[UT][wh/compose/graph/detail/dag_checkpoint_inputs.hpp][dag_runtime::capture_pending_inputs][condition][branch][boundary]") {
...
TEST_CASE("dag pending-input capture becomes a no-op after inputs snapshot already exists",
          "[UT][wh/compose/graph/detail/dag_checkpoint_inputs.hpp][dag_runtime::capture_pending_inputs][condition][boundary]") {
  auto graph = wh::testing::helper::make_runtime_identity_graph(
...
TEST_CASE("dag runtime checkpoint capture records live frontier and edge readers",
          "[UT][wh/compose/graph/detail/dag_checkpoint.hpp][dag_runtime::capture_checkpoint_runtime][condition][boundary]") {
