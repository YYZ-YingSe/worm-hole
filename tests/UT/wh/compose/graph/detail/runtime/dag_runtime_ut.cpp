...
TEST_CASE("dag runtime sizes branch storage and seeds frontier from start entry",
          "[UT][wh/compose/graph/detail/runtime/dag_runtime.hpp][dag_runtime::initialize_entry][condition][branch][boundary]") {
...
TEST_CASE("dag runtime starts with an empty frontier and clears injected start selections after init",
          "[UT][wh/compose/graph/detail/runtime/dag_runtime.hpp][dag_runtime::frontier][condition][branch][boundary]") {
  auto graph = wh::testing::helper::make_runtime_identity_graph(
