...
TEST_CASE("compiled_sync_program returns not supported when no runner is bound",
...
TEST_CASE("compiled_async_program returns not supported when no runner is bound",
...
TEST_CASE("compiled_node_is_sync and compiled_node_is_async reflect stored program variant",
  ...
  auto sync_node = wh::compose::make_compiled_sync_node(
      wh::compose::node_kind::lambda,
      wh::compose::node_exec_origin::authored, wh::compose::node_contract::value,
      wh::compose::node_contract::value, "sync",
      [](wh::compose::graph_value &value, wh::core::run_context &,
         const wh::compose::node_runtime &)
          -> wh::core::result<wh::compose::graph_value> { return value; });
  ...
  auto async_node = wh::compose::make_compiled_async_node(
      wh::compose::node_kind::lambda,
      wh::compose::node_exec_origin::authored, wh::compose::node_contract::value,
      wh::compose::node_contract::value, "async",
      [](wh::compose::graph_value &value, wh::core::run_context &,
         const wh::compose::node_runtime &) {
...
TEST_CASE("make_compiled_sync_node preserves metadata options and executes bound runner",
  ...
  auto sync_node = wh::compose::make_compiled_sync_node(
      ...
      wh::compose::node_exec_origin::lowered, wh::compose::node_contract::value,
...
TEST_CASE("make_compiled_async_node preserves metadata and dispatches async completion",
          "[UT][wh/compose/node/compiled.hpp][make_compiled_async_node][condition][branch][boundary]") {
  auto async_node = wh::compose::make_compiled_async_node(
      wh::compose::node_kind::lambda,
      wh::compose::node_exec_origin::authored, wh::compose::node_contract::value,
      wh::compose::node_contract::value, "async-worker",
      [](wh::compose::graph_value &input, wh::core::run_context &,
         const wh::compose::node_runtime &) {
        auto *typed = wh::core::any_cast<int>(&input);
        REQUIRE(typed != nullptr);
  ...
  wh::core::run_context context{};
  auto async_status =
      await_graph_sender(wh::compose::run_compiled_async_node(async_node,
                                                              async_input,
                                                              context, runtime));
  ...
  auto wrong_async =
      wh::compose::run_compiled_sync_node(async_node, async_input, context, runtime);
