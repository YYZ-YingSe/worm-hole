...
template <typename sender_t> [[nodiscard]] auto await_sender(sender_t &&sender) {
...
TEST_CASE("tools call helpers erase ready failure replay and direct dispatch paths",
  ...
  auto erased_invoke = wh::compose::detail::erase_tools_invoke(
      stdexec::just(wh::core::result<wh::compose::graph_value>{wh::compose::graph_value{1}}));
  ...
  auto collected =
      wh::compose::collect_graph_stream_reader(std::move(erased_stream_status).value());
  ...
  auto ready_completion =
      wh::compose::detail::ready_sender<wh::compose::detail::call_completion_sender>(
  ...
  auto failed_completion =
      wh::compose::detail::failure_sender<wh::compose::detail::call_completion_sender,
  ...
  auto ready_stream =
      wh::compose::detail::ready_sender<wh::compose::detail::stream_completion_sender>(
          wh::core::result<wh::compose::detail::stream_completion>{std::move(stream_completion)});
  ...
  auto erased_call_completion = wh::compose::detail::erase_call_completion(
      stdexec::just(wh::core::result<wh::compose::detail::call_completion>{std::move(completion)}));
  ...
  auto replay_mismatch = wh::compose::detail::replay_stream(wh::compose::graph_value{7});
  REQUIRE(replay_mismatch.has_error());
  REQUIRE(replay_mismatch.error() == wh::core::errc::type_mismatch);

  auto replayed = wh::compose::detail::replay_stream(
      wh::compose::graph_value{std::vector<wh::compose::graph_value>{wh::compose::graph_value{9}}});
  REQUIRE(replayed.has_value());
  auto replayed_values = wh::compose::collect_graph_stream_reader(std::move(replayed).value());
  ...
  options.middleware.push_back({
      .before = [&before_trace](wh::compose::tool_call &call,
      ...
      .after = [&after_trace](const wh::compose::tool_call &call, wh::compose::graph_value &value,
  ...
  registry.emplace("stream-only", wh::compose::tool_entry{
                                      ...
                                      .async_stream = registry.at("echo").async_stream,
                                  });
  ...
  auto missing_value = wh::compose::detail::call_value(state, {.tool_name = "missing"},
                                                       {.run = context,
                                                        .component = "tools",
                                                        .implementation = "tool",
                                                        .tool_name = "missing",
  ...
  auto not_supported_value = wh::compose::detail::call_value(state, {.tool_name = "stream-only"},
                                                             {.run = context,
                                                              .component = "tools",
                                                              .implementation = "tool",
  ...
  auto called_value =
      wh::compose::detail::call_value(state, {.tool_name = "echo", .arguments = "payload"},
                                      {.run = context,
                                       .component = "tools",
                                       .implementation = "tool",
                                       .tool_name = "echo",
  ...
  auto called_stream =
      wh::compose::detail::call_stream(state, {.tool_name = "echo", .arguments = "lane"},
                                       {.run = context,
                                        .component = "tools",
                                        .implementation = "tool",
                                        .tool_name = "echo",
  ...
  auto stream_values = wh::compose::collect_graph_stream_reader(std::move(called_stream).value());
  REQUIRE(stream_values.has_value());
  REQUIRE(*wh::core::any_cast<std::string>(&stream_values.value().front()) == "lane");

  auto started_value = await_sender(
      wh::compose::detail::start_value(state, {.tool_name = "echo", .arguments = "async"},
                                       {.run = context,
                                        .component = "tools",
                                        .implementation = "tool",
                                        .tool_name = "echo",
  ...
  auto started_stream = await_sender(
      wh::compose::detail::start_stream(state, {.tool_name = "echo", .arguments = "async-stream"},
                                        {.run = context,
                                         .component = "tools",
                                         .implementation = "tool",
                                         .tool_name = "echo",
  ...
  REQUIRE(*wh::core::any_cast<std::string>(&started_stream_values.value().front()) ==
          "async-stream");
  ...
  REQUIRE(wh::compose::detail::run_before(options, middleware_call, middleware_scope).has_value());
  REQUIRE(middleware_call.arguments == "payload-before");
  wh::compose::graph_value after_value{std::string{"payload-before"}};
  REQUIRE(wh::compose::detail::run_after(wh::compose::detail::make_tool_after_chain(options),
                                         middleware_call, after_value, middleware_scope)
              .has_value());
  REQUIRE(*wh::core::any_cast<std::string>(&after_value) == "payload-before-after");
...
TEST_CASE("tools call runners cover sync async rerun cache and middleware error branches",
  ...
  sync_state.plans.push_back({.index = 0U, .call = &sync_call, .call_id = "call-0"});
  ...
  REQUIRE(*wh::core::any_cast<std::string>(&sync_completion.value().rerun_extra) == "payload");
  ...
  before_error_state.afters = wh::compose::detail::make_tool_after_chain(before_error_options);
  before_error_state.plans.push_back({.index = 0U, .call = &sync_call, .call_id = "call-0"});
  auto before_error = wh::compose::detail::run_call(before_error_state, 0U, context);
  ...
  after_error_state.afters = wh::compose::detail::make_tool_after_chain(after_error_options);
  after_error_state.plans.push_back({.index = 0U, .call = &sync_call, .call_id = "call-0"});
  auto after_error = wh::compose::detail::run_call(after_error_state, 0U, context);
  ...
  auto stream_completion = wh::compose::detail::run_stream_call(sync_state, 0U, context);
  ...
  auto stream_values =
      wh::compose::collect_graph_stream_reader(std::move(stream_completion).value().stream);
  REQUIRE(stream_values.has_value());
  auto *stream_value = wh::core::any_cast<std::string>(&stream_values.value().front());
  ...
  cached_stream_state.local_rerun.outputs.insert_or_assign(
      "call-0", wh::compose::graph_value{std::vector<wh::compose::graph_value>{
                    wh::compose::graph_value{std::string{"payload-before"}}}});
  auto replayed_stream = wh::compose::detail::run_stream_call(cached_stream_state, 0U, context);
  ...
  auto replayed_values =
      wh::compose::collect_graph_stream_reader(std::move(replayed_stream).value().stream);
  REQUIRE(replayed_values.has_value());
  auto *replayed_value = wh::core::any_cast<std::string>(&replayed_values.value().front());
  REQUIRE(replayed_value != nullptr);
  REQUIRE(*replayed_value == "payload-before");

  auto async_completion = await_sender(wh::compose::detail::start_call(sync_state, 0U, context));
  REQUIRE(async_completion.has_value());
  REQUIRE(*wh::core::any_cast<std::string>(&async_completion.value().value) ==
          "payload-before-after");

  auto async_stream_completion =
      await_sender(wh::compose::detail::start_stream_call(sync_state, 0U, context));
  ...
  auto async_stream_values =
      wh::compose::collect_graph_stream_reader(std::move(async_stream_completion).value().stream);
  REQUIRE(async_stream_values.has_value());
  auto *async_stream_value = wh::core::any_cast<std::string>(&async_stream_values.value().front());
  REQUIRE(async_stream_value != nullptr);
  REQUIRE(*async_stream_value == "payload-before");
}

TEST_CASE(
    "tools stream sender erasure survives stop-driven completion",
  ...
  auto sender = wh::compose::detail::erase_tools_stream(
      stdexec::schedule(wh::testing::helper::manual_scheduler<>{&scheduler_state}) |
      stdexec::then([]() -> wh::core::result<wh::compose::graph_stream_reader> {
        return wh::compose::make_values_stream_reader(
            std::vector<wh::compose::graph_value>{wh::compose::graph_value{1}});
      }));

  wh::testing::helper::sender_capture<wh::core::result<wh::compose::graph_stream_reader>> capture{};
...
TEST_CASE("tools sender erasures preserve outer stopped completion",
          ...
          "call.hpp][erase_tools_invoke][erase_call_completion][erase_stream_completion][lifecycle]"
          "[concurrency]") {
