...
struct async_map_sender {
  auto operator()(wh::compose::graph_value_map &, wh::core::run_context &,
                  const wh::compose::graph_call_scope &) const {
    return stdexec::just(wh::core::result<wh::compose::graph_value_map>{
...
struct async_value_stream_sender {
  auto operator()(wh::compose::graph_value &, wh::core::run_context &,
                  const wh::compose::graph_call_scope &) const {
    return stdexec::just(
        wh::compose::make_single_value_stream_reader(4));
  }
};
...
struct async_stream_stream_sender {
  auto operator()(wh::compose::graph_stream_reader, wh::core::run_context &,
                  const wh::compose::graph_call_scope &) const {
    return stdexec::just(
        wh::compose::make_single_value_stream_reader(8));
  }
};
...
TEST_CASE("lambda concepts accept only matching value map and stream signatures",
...
TEST_CASE("lambda concepts accept canonical value-stream and stream-value signatures",
  ...
  STATIC_REQUIRE(
      wh::compose::value_stream_sender<async_value_stream_sender>);
  STATIC_REQUIRE(wh::compose::stream_value_lambda<sync_stream_value_lambda>);
  STATIC_REQUIRE(
      wh::compose::stream_value_sender<async_stream_value_sender>);
...
TEST_CASE("lambda concepts accept canonical stream-stream signatures and reject mismatches",
  ...
  STATIC_REQUIRE(
      wh::compose::stream_stream_sender<async_stream_stream_sender>);
  ...
  REQUIRE(wh::compose::lambda_contract_supported_v<
          wh::compose::node_exec_mode::async,
                wh::compose::node_contract::stream,
                wh::compose::node_contract::stream,
                async_stream_stream_sender>);
  REQUIRE_FALSE(wh::compose::lambda_contract_supported_v<
                wh::compose::node_exec_mode::async,
                wh::compose::node_contract::stream,
                wh::compose::node_contract::stream, wrong_lambda>);
}
