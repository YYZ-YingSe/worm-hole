...
TEST_CASE("compose stream concat delegates typed and dynamic concat paths",
  ...
  auto typed = wh::compose::stream_concat(registry, std::span<const std::string>{typed_values});
  ...
  auto dynamic =
      wh::compose::stream_concat(registry, wh::core::any_type_key_v<std::string>, dynamic_values);
...
TEST_CASE("compose stream concat surfaces empty unsupported and type mismatch branches",
  ...
  auto mismatch =
      wh::compose::stream_concat(registry, wh::core::any_type_key_v<int>, mismatch_values);
  ...
  auto unsupported =
      wh::compose::stream_concat(registry, wh::core::any_type_key_v<int>, unsupported_values);
