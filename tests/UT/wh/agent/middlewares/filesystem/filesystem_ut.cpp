...
TEST_CASE("filesystem detail helpers parse normalize format and downshift text results",
          "[UT][wh/agent/middlewares/filesystem/filesystem.hpp][detail::parse_json_object][condition][branch][boundary]") {
  ...
  auto invalid_json =
      wh::agent::middlewares::filesystem::detail::parse_json_object("{");
  REQUIRE(invalid_json.has_error());
  auto wrong_json =
      wh::agent::middlewares::filesystem::detail::parse_json_object(R"(["x"])");
  REQUIRE(wrong_json.has_error());
  REQUIRE(wrong_json.error() == wh::core::errc::type_mismatch);

  auto optional_path =
      wh::agent::middlewares::filesystem::detail::optional_string_member(
          parsed.value(), "path");
  ...
  auto required_path =
      wh::agent::middlewares::filesystem::detail::required_string_member(
          parsed.value(), "path");
  ...
  auto offset = wh::agent::middlewares::filesystem::detail::optional_signed_member(
      parsed.value(), "offset");
  REQUIRE(offset.has_value());
  REQUIRE(offset.value() == std::optional<std::int64_t>{-1});
  auto no_offset =
      wh::agent::middlewares::filesystem::detail::optional_signed_member(
          parsed.value(), "none");
  ...
  auto flag = wh::agent::middlewares::filesystem::detail::optional_bool_member(
      parsed.value(), "flag");
  REQUIRE(flag.has_value());
  REQUIRE(flag.value() == std::optional<bool>{true});
  auto no_flag =
      wh::agent::middlewares::filesystem::detail::optional_bool_member(
          parsed.value(), "none");
  ...
  REQUIRE(
      wh::agent::middlewares::filesystem::detail::normalize_offset(std::nullopt) ==
      0U);
  ...
  REQUIRE(
      wh::agent::middlewares::filesystem::detail::normalize_limit(std::nullopt) ==
      4096U);
  ...
  REQUIRE(wh::agent::middlewares::filesystem::detail::parse_grep_mode(std::nullopt) ==
          wh::agent::middlewares::filesystem::filesystem_grep_mode::
              files_with_matches);
  ...
  const std::vector<wh::agent::middlewares::filesystem::filesystem_grep_match>
      grep_entries{
  ...
  REQUIRE(wh::agent::middlewares::filesystem::detail::large_result_path(
              large, "call-1") == "/tmp/result/call-1");
  REQUIRE(wh::agent::middlewares::filesystem::detail::preview_text(
              "line1\nline2\nline3") == "line1\nline2\nline3");
  ...
  REQUIRE(shifted.value().find("Large result saved to /tmp/result/call-2") !=
          std::string::npos);

  wh::agent::middlewares::filesystem::filesystem_backend missing_large_backend{};
  auto missing_large =
      wh::agent::middlewares::filesystem::detail::materialize_text_result(
  ...
  failing_large_backend.write_large_result =
      [](const std::string_view, const std::string_view)
          -> wh::core::result<void> {
  ...
  auto value =
      wh::agent::middlewares::filesystem::detail::graph_string_value("ok");
  REQUIRE(value.has_value());
  REQUIRE(*wh::core::any_cast<std::string>(&value.value()) == "ok");
  REQUIRE(wh::agent::middlewares::filesystem::detail::make_string_parameter(
              "path", "desc", false)
              .required == false);
  REQUIRE(wh::agent::middlewares::filesystem::detail::make_integer_parameter(
              "limit", "desc", true)
              .required);
  REQUIRE(wh::agent::middlewares::filesystem::detail::make_bool_parameter(
              "replace_all", "desc", false)
...
TEST_CASE("filesystem middleware builds six tools in stable order and mounts them into toolset",
          "[UT][wh/agent/middlewares/filesystem/filesystem.hpp][make_filesystem_tool_bindings][condition][branch][boundary]") {
  wh::agent::middlewares::filesystem::filesystem_backend invalid_backend{};
  auto invalid = wh::agent::middlewares::filesystem::make_filesystem_tool_bindings(
      invalid_backend);
  ...
  wh::agent::middlewares::filesystem::filesystem_backend backend{
      ...
      .write =
          [](const std::string_view, const std::string_view)
              -> wh::core::result<void> { return {}; },
      .edit =
          [&replace_all_seen](const std::string_view, const std::string_view,
                              const std::string_view, const bool replace_all)
              -> wh::core::result<void> {
  ...
  auto bindings =
      wh::agent::middlewares::filesystem::make_filesystem_tool_bindings(backend,
                                                                        options);
  ...
  auto edit_result = bindings.value()[3].entry.invoke(
      wh::compose::tool_call{
          ...
          .tool_name = "edit_file",
          .arguments =
              R"({"path":"file.txt","search":"a","replace":"b","replace_all":true})"},
  ...
  auto mounted =
      wh::agent::middlewares::filesystem::mount_filesystem_tools(toolset, backend,
                                                                 options);
