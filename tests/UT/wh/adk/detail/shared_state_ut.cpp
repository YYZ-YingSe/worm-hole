...
TEST_CASE("shared_process_state resolves root state for root and child process states",
...
TEST_CASE("emplace_shared_state inserts into shared parent store and replaces prior value",
  ...
  auto overwritten =
      wh::adk::detail::emplace_shared_state<shared_counter>(root, 11);
