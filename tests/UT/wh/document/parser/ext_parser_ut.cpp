...
TEST_CASE("ext parser validates registrations normalizes extensions and exposes registry copy",
  ...
  auto registered =
      parser.register_parser(".txt", wh::document::parser::make_text_parser());
...
TEST_CASE("ext parser routes by extension strips empty documents and falls back",
  ...
  wh::document::parser::ext_parser parser{};
  REQUIRE(parser
              .register_parser(".empty", wh::document::parser::parser{
                                             maybe_empty_parser{}})
              .has_value());
  ...
  auto fallback = parser.parse(
      wh::document::parser::parse_request_view{
          .content = "hello",
...
TEST_CASE(
    ...
    "[UT][wh/document/parser/ext_parser.hpp][ext_parser::set_fallback][condition][branch][boundary]") {
  wh::document::parser::ext_parser parser{};
  ...
  REQUIRE(parser
              .register_parser(std::string{"md"},
                               wh::document::parser::parser{maybe_empty_parser{}})
              .has_value());
