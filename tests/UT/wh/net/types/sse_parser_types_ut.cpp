...
TEST_CASE("sse parser types project owned requests into borrowed views",
          "[UT][wh/net/types/sse_parser_types.hpp][make_sse_parse_request_view][condition][branch][boundary]") {
...
TEST_CASE("sse parser types default output and raw payload variants stay distinct",
  ...
  raw.payload = wh::net::raw_stream_chunk{
