...
TEST_CASE("http client concept accepts complete transport adapters",
          "[UT][wh/net/concepts/http_client_concept.hpp][http_client_like][condition][branch][boundary]") {
...
TEST_CASE("http client concept rejects adapters missing json and stream entrypoints",
          "[UT][wh/net/concepts/http_client_concept.hpp][http_client_like][condition][branch][boundary][negative]") {
