...
struct concept_dns_cache {
  ...
  auto lookup(const wh::net::dns_lookup_request_view) const -> wh::net::dns_lookup_result;
...
TEST_CASE(
    "dns cache concept accepts complete cache adapters",
...
TEST_CASE("dns cache concept rejects adapters without invalidation entrypoint",
          "[UT][wh/net/concepts/"
          "dns_cache_concept.hpp][dns_cache_like][condition][branch][boundary][negative]") {
