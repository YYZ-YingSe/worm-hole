...
TEST_CASE("sse parser concept accepts complete parser adapters",
...
TEST_CASE("sse parser concept rejects adapters missing borrowed or movable parse overloads",
          "[UT][wh/net/concepts/sse_parser_concept.hpp][sse_parser_like][condition][branch][boundary][negative]") {
