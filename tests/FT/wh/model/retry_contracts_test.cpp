...
[[nodiscard]] auto collect_stream_text(
    wh::model::chat_message_stream_reader &reader) -> std::vector<std::string> {
  ...
  while (true) {
    ...
    output.push_back(std::get<wh::schema::text_part>(
                         next.value().value->parts.front())
                         .text);
  }
  return output;
}
...
struct flaky_invoke_model_impl {
  ...
  [[nodiscard]] auto descriptor() const -> wh::core::component_descriptor {
    return wh::core::component_descriptor{"FlakyInvokeModel",
  ...
  [[nodiscard]] auto invoke(const wh::model::chat_request &) const
    ...
    return wh::model::chat_response{
        .message = make_assistant_message(state->success_text)};
  }
...
struct scripted_message_reader {
  ...
  [[nodiscard]] auto read() -> chunk_result_type {
    ...
    if (next.has_value() &&
        (next.value().eof || next.value().error.failed())) {
      closed_ = true;
    }
    if (next.has_error()) {
      closed_ = true;
...
struct flaky_stream_model_impl {
  ...
  [[nodiscard]] auto descriptor() const -> wh::core::component_descriptor {
    return wh::core::component_descriptor{"FlakyStreamModel",
                                          wh::core::component_kind::model};
  }
  ...
  [[nodiscard]] auto invoke(const wh::model::chat_request &) const
    ...
    ++state->invoke_calls;
    return wh::model::chat_response{
        .message = make_assistant_message("invoke")};
  }
  ...
  [[nodiscard]] auto stream(const wh::model::chat_request &) const
    ...
    if (state->stream_calls == 1U) {
      return wh::model::chat_message_stream_reader{
          scripted_message_reader{state->first_attempt}};
    }
    return wh::model::chat_message_stream_reader{
        scripted_message_reader{state->second_attempt}};
  }

  [[nodiscard]] auto bind_tools(
      const std::span<const wh::schema::tool_schema_definition>) const
...
TEST_CASE("retry chat model retries invoke failures and preserves tool binding",
  ...
  auto bound = retry.bind_tools(std::span<const wh::schema::tool_schema_definition>{
      &tool, 1U});
  ...
  auto registered = register_test_callbacks(
      std::move(context),
      [](const wh::core::callback_stage) noexcept -> bool { return true; },
      [&retry_events](const wh::core::callback_stage stage, const wh::core::callback_event_view event,
                      const wh::core::callback_run_info &) {
        if (stage != wh::core::callback_stage::error) {
          return;
        }
        if (const auto *typed =
                wh::core::any_cast<wh::model::will_retry_error>(&event);
            typed != nullptr) {
  ...
  REQUIRE(std::get<wh::schema::text_part>(status.value().message.parts.front()).text ==
          "ok");
...
TEST_CASE("retry chat model returns retry_exhausted after final retryable failure",
  ...
  auto registered = register_test_callbacks(
      ...
      [&exhausted](const wh::core::callback_stage stage, const wh::core::callback_event_view event,
        ...
        if (const auto *typed =
                wh::core::any_cast<wh::model::retry_exhausted_error>(&event);
            typed != nullptr) {
...
TEST_CASE("retry chat model custom predicate can stop retries immediately",
  ...
  wh::model::retry_chat_model<invoke_model> retry{
      ...
      wh::model::retry_chat_model_options{
          .max_attempts = 4U,
          .should_retry = wh::model::retry_predicate{
              [](const wh::core::error_code error) noexcept -> bool {
...
TEST_CASE("retry chat model stream probe hides failed attempt fragments from success path",
  ...
  state.second_attempt = {
      ...
      scripted_message_reader::chunk_result_type{
          scripted_message_reader::chunk_type::make_eof()},
  };
