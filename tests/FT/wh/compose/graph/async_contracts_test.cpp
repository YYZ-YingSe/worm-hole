...
TEST_CASE("compose graph dispatch policy controls frontier wave promotion",
  ...
  auto run_case = [&](const wh::compose::graph_dispatch_policy dispatch_policy) -> bool {
    ...
    REQUIRE(graph
                .add_lambda<wh::compose::node_contract::value, wh::compose::node_contract::value,
                    ...
                    [&](const wh::compose::graph_value &, wh::core::run_context &,
                      ...
                      return stdexec::starts_on(worker_pool.get_scheduler(),
                ...
                .add_lambda<wh::compose::node_contract::value, wh::compose::node_contract::value,
                    ...
                    [&](const wh::compose::graph_value &, wh::core::run_context &,
                      ...
                      return stdexec::starts_on(
                          ...
                          }) | stdexec::let_value([release_x] {
                            return release_x->wait();
                          }) | stdexec::let_value([scheduler = worker_pool.get_scheduler()] {
    ...
    REQUIRE(graph
                .add_lambda("b",
                            [&](const wh::compose::graph_value &, wh::core::run_context &,
                              ...
                              const auto released = x_released.load(std::memory_order_acquire);
                              b_started_before_release.store(!released, std::memory_order_release);
                ...
                .add_lambda(
                    ...
                    [](const wh::compose::graph_value &input, wh::core::run_context &,
                      ...
                      if (x_value.has_error()) {
                        return wh::core::result<wh::compose::graph_value>::failure(x_value.error());
                      }
                      if (b_value.has_error()) {
                        return wh::core::result<wh::compose::graph_value>::failure(b_value.error());
                      }
    ...
    auto op =
        stdexec::connect(graph.invoke(context, make_graph_request(wh::core::any(1))),
...
TEST_CASE("compose dag executes ready async branches concurrently", "[core][compose][dag][async]") {
  wh::compose::graph_compile_options options{};
  options.mode = wh::compose::graph_runtime_mode::dag;
  options.max_parallel_nodes = 2U;
  options.trigger_mode = wh::compose::graph_trigger_mode::all_predecessors;
  ...
  REQUIRE(graph
              .add_lambda<wh::compose::node_contract::value, wh::compose::node_contract::value,
                          wh::compose::node_exec_mode::async>("left", make_branch(10))
              .has_value());
  REQUIRE(graph
              .add_lambda<wh::compose::node_contract::value, wh::compose::node_contract::value,
                          wh::compose::node_exec_mode::async>("right", make_branch(20))
              .has_value());
  REQUIRE(graph
              .add_lambda(
                  "join",
      ...
      return stdexec::starts_on(
          ...
          stdexec::just(wh::core::any(value)) |
              stdexec::then([](wh::compose::graph_value payload)
                                -> wh::core::result<wh::compose::graph_value> { return payload; }));
    };
  };
...
TEST_CASE("compose dag async invoke passes call options directly to async lambda",
          ...
          .add_lambda<wh::compose::node_contract::value, wh::compose::node_contract::value,
              ...
              [&](const wh::compose::graph_value &, wh::core::run_context &,
                ...
                return stdexec::starts_on(
                    ...
                    stdexec::just() |
                        stdexec::then(
                            [captured_options, &saw_call_options, &saw_timeout,
                             &saw_policy]() -> wh::core::result<wh::compose::graph_value> {
                              saw_call_options.store(true, std::memory_order_release);
                              ...
                              saw_timeout.store(true, std::memory_order_release);
                              if (!captured_options.external_interrupt_policy().has_value() ||
                                  captured_options.external_interrupt_policy()->mode !=
                                      wh::compose::graph_interrupt_timeout_mode::wait_inflight ||
                                  captured_options.external_interrupt_policy()->timeout !=
                                      std::optional<std::chrono::milliseconds>{
                                          std::chrono::milliseconds{40}}) {
                                return wh::core::result<wh::compose::graph_value>::failure(
                                    wh::core::errc::contract_violation);
                              }
                              saw_policy.store(true, std::memory_order_release);
  ...
  auto invoked = invoke_value_sync(graph, wh::core::any(0), context, std::move(call_options));
