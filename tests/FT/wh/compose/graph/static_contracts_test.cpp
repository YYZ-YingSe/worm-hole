...
struct graph_view_only_subgraph_stub {
  ...
  [[nodiscard]] auto graph_view() const noexcept -> const wh::compose::graph & { return graph_; }
};

template <wh::compose::node_contract From, wh::compose::node_contract To,
          wh::compose::node_exec_mode Exec, typename lambda_t>
concept lambda_node_factory_available =
    requires { wh::compose::make_lambda_node<From, To, Exec>("node", std::declval<lambda_t>()); };
...
concept custom_component_node_factory_available = requires {
  wh::compose::make_component_node<wh::core::component_kind::custom, From, To, request_t,
...
concept tools_node_factory_available = requires {
  wh::compose::make_tools_node<From, To, Exec>("tools", wh::compose::tool_registry{});
};

template <typename graph_t>
concept subgraph_node_factory_available =
    requires { wh::compose::make_subgraph_node("child", std::declval<graph_t>()); };

template <typename graph_t>
concept chain_append_subgraph_available =
    requires(wh::compose::chain chain) { chain.append_subgraph("child", std::declval<graph_t>()); };

template <typename graph_t>
concept parallel_add_subgraph_available = requires(wh::compose::parallel parallel) {
  parallel.add_subgraph("child", std::declval<graph_t>());
};

template <typename graph_t>
concept workflow_add_subgraph_step_available = requires(wh::compose::workflow workflow) {
  workflow.add_subgraph_step("child", std::declval<graph_t>());
};

inline constexpr bool workflow_step_lookup_available =
    requires(wh::compose::workflow workflow) { workflow.step("node"); };

inline constexpr bool workflow_end_available =
    requires(wh::compose::workflow workflow) { workflow.end(); };

template <typename workflow_t>
concept workflow_legacy_dependency_api_available =
    requires(workflow_t workflow) { workflow.add_dependency(wh::compose::workflow_dependency{}); };
...
struct inline_scheduler_env {
  ...
  [[nodiscard]] auto query(stdexec::get_scheduler_t) const noexcept -> stdexec::inline_scheduler {
    return scheduler;
  }
...
template <typename env_t> struct graph_invoke_receiver {
  ...
  auto set_value(wh::core::result<wh::compose::graph_invoke_result>) && noexcept -> void {}
...
concept graph_invoke_sender_connectable = requires(
    wh::compose::graph graph, wh::core::run_context context, receiver_t receiver) {
  stdexec::connect(graph.invoke(context, wh::compose::graph_invoke_request{}), std::move(receiver));
};
...
template <typename receiver_t>
concept graph_stream_write_sender_connectable = requires(wh::compose::graph_stream_writer writer,
                                                         receiver_t receiver) {
  stdexec::connect(std::move(writer).write_async(wh::compose::graph_value{}), std::move(receiver));
};

template <wh::compose::node_contract Contract>
concept passthrough_node_factory_available =
    requires { wh::compose::make_passthrough_node<Contract>("node"); };

static_assert(graph_invoke_sender_connectable<graph_invoke_receiver<inline_scheduler_env>>);
...
static_assert(graph_invoke_sender_connectable<graph_invoke_receiver<no_scheduler_env>>);
static_assert(
    graph_stream_read_sender_connectable<graph_stream_read_receiver<inline_scheduler_env>>);
static_assert(!graph_stream_read_sender_connectable<graph_stream_read_receiver<no_scheduler_env>>);
static_assert(
    graph_stream_write_sender_connectable<graph_stream_write_receiver<inline_scheduler_env>>);
static_assert(
    !graph_stream_write_sender_connectable<graph_stream_write_receiver<no_scheduler_env>>);
...
struct lambda_vv_sync_ok {
  auto operator()(wh::compose::graph_value &, wh::core::run_context &,
    ...
    return wh::core::result<wh::compose::graph_value>::failure(wh::core::errc::not_supported);
  }
};
...
struct lambda_vv_async_ok {
  auto operator()(wh::compose::graph_value &, wh::core::run_context &,
                  const wh::compose::graph_call_scope &) const {
    return stdexec::just(
        wh::core::result<wh::compose::graph_value>::failure(wh::core::errc::not_supported));
  }
};
...
struct lambda_vs_async_ok {
  auto operator()(wh::compose::graph_value &, wh::core::run_context &,
                  const wh::compose::graph_call_scope &) const {
    return stdexec::just(
        wh::core::result<wh::compose::graph_stream_reader>::failure(wh::core::errc::not_supported));
  }
};
...
using graph_values_reader =
    wh::schema::stream::values_stream_reader<std::vector<wh::compose::graph_value>>;
...
struct lambda_vs_async_canonical_ok {
  auto operator()(wh::compose::graph_value &, wh::core::run_context &,
                  const wh::compose::graph_call_scope &) const {
    return stdexec::just(
        wh::core::result<graph_values_reader>::failure(wh::core::errc::not_supported));
  }
};
...
struct prompt_component_stub {
  ...
  auto async_render(wh::prompt::prompt_render_request, wh::core::run_context &) const {
    return stdexec::just(
        wh::core::result<std::vector<wh::schema::message>>::failure(wh::core::errc::not_supported));
  }
};
...
struct embedding_component_stub {
  ...
  auto async_embed(wh::embedding::embedding_request, wh::core::run_context &) const {
    return stdexec::just(wh::core::result<wh::embedding::embedding_response>::failure(
        wh::core::errc::not_supported));
  }
};
...
struct retriever_component_stub {
  ...
  auto async_retrieve(wh::retriever::retriever_request, wh::core::run_context &) const {
    return stdexec::just(wh::core::result<wh::retriever::retriever_response>::failure(
        wh::core::errc::not_supported));
  }
};
...
struct indexer_component_stub {
  auto write(wh::indexer::indexer_request, wh::core::run_context &) const
    ...
    return wh::core::result<wh::indexer::indexer_response>::failure(wh::core::errc::not_supported);
  }

  auto async_write(wh::indexer::indexer_request, wh::core::run_context &) const {
    return stdexec::just(
        wh::core::result<wh::indexer::indexer_response>::failure(wh::core::errc::not_supported));
  }
};
...
struct document_component_stub {
  auto process(wh::document::document_request, wh::core::run_context &) const
    ...
    return wh::core::result<wh::document::document_batch>::failure(wh::core::errc::not_supported);
  }

  auto async_process(wh::document::document_request, wh::core::run_context &) const {
    return stdexec::just(
        wh::core::result<wh::document::document_batch>::failure(wh::core::errc::not_supported));
  }
};
...
struct tool_component_stub {
  ...
  auto stream(wh::tool::tool_request, wh::core::run_context &) const
    ...
    return wh::tool::tool_output_stream_result::failure(wh::core::errc::not_supported);
  }

  auto async_invoke(wh::tool::tool_request, wh::core::run_context &) const {
    return stdexec::just(wh::tool::tool_invoke_result::failure(wh::core::errc::not_supported));
  }

  auto async_stream(wh::tool::tool_request, wh::core::run_context &) const {
    return stdexec::just(
        wh::tool::tool_output_stream_result::failure(wh::core::errc::not_supported));
  }
};
...
struct custom_value_move_only_sync_stub {
  auto invoke(int, wh::core::run_context &) const -> wh::core::result<std::unique_ptr<int>> {
    return wh::core::result<std::unique_ptr<int>>::failure(wh::core::errc::not_supported);
  }
};
...
struct custom_value_any_sync_stub {
  auto invoke(int, wh::core::run_context &) const -> wh::core::result<wh::core::any> {
    return wh::core::result<wh::core::any>::failure(wh::core::errc::not_supported);
  }
};

struct custom_value_async_stub {
  auto async_invoke(int, wh::core::run_context &) const {
    return stdexec::just(wh::core::result<int>::failure(wh::core::errc::not_supported));
  }
};
...
struct custom_stream_canonical_sync_stub {
  auto stream(int, wh::core::run_context &) const -> wh::core::result<graph_values_reader> {
    return graph_values_reader{std::vector<wh::compose::graph_value>{}};
  }
};
...
struct custom_value_bad_async_stub {
  auto async_invoke(int, wh::core::run_context &) const { return stdexec::just(1); }
};
...
static_assert(lambda_node_factory_available<wh::compose::node_contract::value,
                                            ...
                                            wh::compose::node_exec_mode::sync, lambda_vv_sync_ok>);
static_assert(lambda_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::value,
              wh::compose::node_exec_mode::async, lambda_vv_async_ok>);
static_assert(lambda_node_factory_available<wh::compose::node_contract::value,
                                            wh::compose::node_contract::stream,
                                            wh::compose::node_exec_mode::sync, lambda_vs_sync_ok>);
static_assert(lambda_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::stream,
              wh::compose::node_exec_mode::async, lambda_vs_async_ok>);
static_assert(lambda_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::stream,
              wh::compose::node_exec_mode::sync, lambda_vs_sync_canonical_ok>);
static_assert(lambda_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::stream,
              wh::compose::node_exec_mode::async, lambda_vs_async_canonical_ok>);
static_assert(lambda_node_factory_available<wh::compose::node_contract::stream,
                                            wh::compose::node_contract::value,
                                            wh::compose::node_exec_mode::sync, lambda_sv_sync_ok>);
static_assert(lambda_node_factory_available<
              wh::compose::node_contract::stream, wh::compose::node_contract::value,
              wh::compose::node_exec_mode::async, lambda_sv_async_ok>);
static_assert(lambda_node_factory_available<wh::compose::node_contract::stream,
                                            wh::compose::node_contract::stream,
                                            wh::compose::node_exec_mode::sync, lambda_ss_sync_ok>);
static_assert(lambda_node_factory_available<
              wh::compose::node_contract::stream, wh::compose::node_contract::stream,
              wh::compose::node_exec_mode::async, lambda_ss_async_ok>);
static_assert(!lambda_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::stream,
              wh::compose::node_exec_mode::async, lambda_vs_async_bad_sender>);
static_assert(!lambda_node_factory_available<
              wh::compose::node_contract::stream, wh::compose::node_contract::value,
              wh::compose::node_exec_mode::sync, lambda_sv_sync_bad_input>);

static_assert(explicit_component_node_factory_available<
              wh::core::component_kind::model, wh::compose::node_contract::value,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::sync,
...
static_assert(explicit_component_node_factory_available<
              ...
              model_component_stub>);
static_assert(!explicit_component_node_factory_available<
              wh::core::component_kind::model, wh::compose::node_contract::stream,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::sync,
              model_component_stub>);
static_assert(!explicit_component_node_factory_available<
              wh::core::component_kind::model, wh::compose::node_contract::value,
...
static_assert(explicit_component_node_factory_available<
              wh::core::component_kind::prompt, wh::compose::node_contract::value,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::sync,
...
static_assert(explicit_component_node_factory_available<
              wh::core::component_kind::embedding, wh::compose::node_contract::value,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::sync,
...
static_assert(explicit_component_node_factory_available<
              ...
              embedding_component_stub>);
static_assert(!explicit_component_node_factory_available<
              wh::core::component_kind::embedding, wh::compose::node_contract::stream,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::sync,
              embedding_component_stub>);

static_assert(explicit_component_node_factory_available<
              wh::core::component_kind::retriever, wh::compose::node_contract::value,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::sync,
...
static_assert(explicit_component_node_factory_available<
              wh::core::component_kind::indexer, wh::compose::node_contract::value,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::sync,
...
static_assert(explicit_component_node_factory_available<
              wh::core::component_kind::document, wh::compose::node_contract::value,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::sync,
...
static_assert(
    explicit_component_node_factory_available<
        wh::core::component_kind::tool, wh::compose::node_contract::value,
        wh::compose::node_contract::value, wh::compose::node_exec_mode::sync, tool_component_stub>);
static_assert(explicit_component_node_factory_available<
              wh::core::component_kind::tool, wh::compose::node_contract::value,
              wh::compose::node_contract::value, wh::compose::node_exec_mode::async,
              tool_component_stub>);
...
static_assert(
    !explicit_component_node_factory_available<
        wh::core::component_kind::tool, wh::compose::node_contract::stream,
        wh::compose::node_contract::value, wh::compose::node_exec_mode::sync, tool_component_stub>);
...
static_assert(custom_component_node_factory_available<
              ...
              wh::compose::node_exec_mode::sync, custom_value_sync_stub>);
static_assert(
    !custom_component_node_factory_available<
        wh::compose::node_contract::value, wh::compose::node_contract::value, int,
        std::unique_ptr<int>, wh::compose::node_exec_mode::sync, custom_value_move_only_sync_stub>);
static_assert(!custom_component_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::value, int,
              wh::compose::graph_stream_reader, wh::compose::node_exec_mode::sync,
              custom_value_reader_sync_stub>);
static_assert(custom_component_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::value, int,
              wh::core::any, wh::compose::node_exec_mode::sync, custom_value_any_sync_stub>);
static_assert(custom_component_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::value, int, int,
              wh::compose::node_exec_mode::async, custom_value_async_stub>);
static_assert(custom_component_node_factory_available<
...
static_assert(
    custom_component_node_factory_available<
        wh::compose::node_contract::value, wh::compose::node_contract::stream, int,
        graph_values_reader, wh::compose::node_exec_mode::sync, custom_stream_canonical_sync_stub>);
static_assert(custom_component_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::stream, int,
              graph_values_reader, wh::compose::node_exec_mode::async,
              custom_stream_canonical_async_stub>);
static_assert(custom_component_node_factory_available<
              wh::compose::node_contract::stream, wh::compose::node_contract::value,
              wh::compose::graph_stream_reader, int, wh::compose::node_exec_mode::sync,
...
static_assert(custom_component_node_factory_available<
              ...
              wh::compose::node_exec_mode::async, custom_stream_async_stub>);
static_assert(!custom_component_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::value, int, int,
              wh::compose::node_exec_mode::async, custom_value_bad_async_stub>);
static_assert(!custom_component_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::stream, int,
              wh::compose::graph_stream_reader, wh::compose::node_exec_mode::async,
...
static_assert(!custom_component_node_factory_available<
              wh::compose::node_contract::stream, wh::compose::node_contract::value, int, int,
              wh::compose::node_exec_mode::sync, custom_stream_wrong_request_sync_stub>);
static_assert(!custom_component_node_factory_available<
              wh::compose::node_contract::value, wh::compose::node_contract::stream, int, int,
              wh::compose::node_exec_mode::sync, custom_stream_bad_response_sync_stub>);
...
static_assert(passthrough_node_factory_available<wh::compose::node_contract::value>);
static_assert(passthrough_node_factory_available<wh::compose::node_contract::stream>);
