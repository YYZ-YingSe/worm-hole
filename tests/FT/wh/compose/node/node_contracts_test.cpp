...
[[nodiscard]] auto make_streaming_subgraph_graph() -> wh::core::result<wh::compose::graph> {
...
TEST_CASE("compose component node binds embedding component explicitly",
  ...
  auto node = wh::compose::make_component_node<wh::compose::component_kind::embedding,
                                               ...
                                               wh::compose::node_contract::value>(
      "embed", std::move(component));
  wh::core::run_context context{};
  auto output = invoke_single_node_graph(node,
                                         wh::core::any(wh::embedding::embedding_request{
                                             .inputs = std::vector<std::string>{"a", "abcd"}}),
                                         context);
...
TEST_CASE("compose component node binds chat model invoke and stream explicitly",
  ...
  auto invoke_node = wh::compose::make_component_node<wh::compose::component_kind::model,
                                                      wh::compose::node_contract::value,
                                                      wh::compose::node_contract::value>(
      "chat-invoke", wh::model::echo_chat_model{});
  wh::core::run_context context{};
  auto invoke_output = execute_single_compiled_node(invoke_node, wh::core::any(request), context);
  REQUIRE(invoke_output.has_value());
  auto invoke_typed = read_any<wh::model::chat_response>(invoke_output.value());
  REQUIRE(invoke_typed.has_value());
  REQUIRE(std::get<wh::schema::text_part>(invoke_typed.value().message.parts.front()).text ==
          "hello model");

  auto stream_node = wh::compose::make_component_node<wh::compose::component_kind::model,
                                                      wh::compose::node_contract::value,
                                                      wh::compose::node_contract::stream>(
      "chat-stream", wh::model::echo_chat_model{});
  auto stream_output =
      execute_single_compiled_node(stream_node, wh::core::any(std::move(request)), context);
  REQUIRE(stream_output.has_value());
  auto stream_reader = read_any<wh::compose::graph_stream_reader>(std::move(stream_output).value());
  REQUIRE(stream_reader.has_value());
  auto chunk = stream_reader.value().read();
  REQUIRE(chunk.has_value());
  REQUIRE(chunk.value().value.has_value());
  auto message = read_any<wh::schema::message>(std::move(*chunk.value().value));
  REQUIRE(message.has_value());
  REQUIRE(std::get<wh::schema::text_part>(message.value().parts.front()).text == "hello model");
}
...
TEST_CASE("compose component node binds prompt retriever and indexer explicitly",
  ...
  auto prompt_node = wh::compose::make_component_node<wh::compose::component_kind::prompt,
                                                      wh::compose::node_contract::value,
                                                      wh::compose::node_contract::value>(
      "prompt", std::move(prompt));
  wh::core::run_context context{};
  auto prompt_output = invoke_single_node_graph(
      prompt_node, wh::core::any(wh::prompt::prompt_render_request{placeholders, {}}), context);
  REQUIRE(prompt_output.has_value());
  auto rendered = read_any<std::vector<wh::schema::message>>(prompt_output.value());
  REQUIRE(rendered.has_value());
  REQUIRE(rendered.value().size() == 1U);
  REQUIRE(std::get<wh::schema::text_part>(rendered.value().front().parts.front()).text ==
          "Hello compose");

  wh::retriever::retriever retriever{
      sync_retriever_impl{[](const wh::retriever::retriever_request &request)
                              -> wh::core::result<wh::retriever::retriever_response> {
        return wh::retriever::retriever_response{wh::schema::document{"hit:" + request.query}};
      }}};
  auto retriever_node = wh::compose::make_component_node<wh::compose::component_kind::retriever,
                                                         wh::compose::node_contract::value,
                                                         wh::compose::node_contract::value>(
      "retriever", std::move(retriever));
  auto retriever_output = invoke_single_node_graph(
      retriever_node,
      wh::core::any(wh::retriever::retriever_request{.query = "needle", .index = "idx"}), context);
  REQUIRE(retriever_output.has_value());
  auto retrieved = read_any<wh::retriever::retriever_response>(retriever_output.value());
  REQUIRE(retrieved.has_value());
  REQUIRE(retrieved.value().size() == 1U);
  REQUIRE(retrieved.value().front().content() == "hit:needle");

  wh::indexer::indexer indexer{
      sync_indexer_batch_impl{[](const wh::indexer::indexer_request &request)
  ...
  auto indexer_node = wh::compose::make_component_node<wh::compose::component_kind::indexer,
                                                       wh::compose::node_contract::value,
                                                       wh::compose::node_contract::value>(
      "indexer", std::move(indexer));
  auto indexer_output = invoke_single_node_graph(
      indexer_node,
      wh::core::any(wh::indexer::indexer_request{.documents = {wh::schema::document{"doc-1"}}}),
      context);
  REQUIRE(indexer_output.has_value());
  auto indexed = read_any<wh::indexer::indexer_response>(indexer_output.value());
...
TEST_CASE("compose component node binds document component explicitly",
  ...
  wh::core::run_context context{};
  auto output = invoke_single_node_graph(node, wh::core::any(std::move(request)), context);
  REQUIRE(output.has_value());
  ...
  REQUIRE(typed.value().front().metadata_or<std::string>("_source") == "mem://doc.txt");
}
...
TEST_CASE("compose component node binds tool stream component explicitly",
  ...
  auto stream_node = wh::compose::make_component_node<wh::compose::component_kind::tool,
                                                      wh::compose::node_contract::value,
                                                      wh::compose::node_contract::stream>(
      "echo-stream", std::move(component));
  auto stream_output = execute_single_compiled_node(
      stream_node, wh::core::any(wh::tool::tool_request{.input_json = "payload"}), context);
  REQUIRE(stream_output.has_value());
  auto stream_reader = read_any<wh::compose::graph_stream_reader>(std::move(stream_output).value());
  REQUIRE(stream_reader.has_value());
...
TEST_CASE("compose component node binds custom exact contracts explicitly",
  ...
  auto value_value = wh::compose::make_component_node<wh::compose::component_kind::custom,
                                                      wh::compose::node_contract::value,
                                                      wh::compose::node_contract::value, int, int>(
      "custom-vv", custom_value_value_component{});
  auto value_value_output = execute_single_compiled_node(value_value, wh::core::any(7), context);
  ...
  auto value_stream_output = execute_single_compiled_node(value_stream, wh::core::any(4), context);
  ...
  auto [stream_stream_writer, stream_stream_reader] = wh::compose::make_graph_stream();
  ...
  auto stream_stream = wh::compose::make_component_node<
      ...
      wh::compose::graph_stream_reader>("custom-ss", custom_stream_stream_component{});
...
TEST_CASE("compose authored nodes preserve explicit execution mode metadata",
  ...
  REQUIRE(compiled_sync_lambda->node->meta.exec_mode == wh::compose::node_exec_mode::sync);
  REQUIRE(compiled_sync_lambda->node->meta.exec_origin == wh::compose::node_exec_origin::authored);

  auto async_lambda = wh::compose::make_lambda_node<wh::compose::node_contract::value,
                                                    wh::compose::node_contract::value,
                                                    wh::compose::node_exec_mode::async>(
      "async-lambda", [](const wh::compose::graph_value &input, wh::core::run_context &,
  ...
  REQUIRE(compiled_async_lambda->node->meta.exec_mode == wh::compose::node_exec_mode::async);
  REQUIRE(compiled_async_lambda->node->meta.exec_origin == wh::compose::node_exec_origin::authored);
  ...
  auto sync_component = wh::compose::make_component_node<wh::compose::component_kind::embedding,
                                                         wh::compose::node_contract::value,
                                                         wh::compose::node_contract::value>(
  ...
  REQUIRE(compiled_sync_component->node->meta.exec_mode == wh::compose::node_exec_mode::sync);
  ...
  REQUIRE(compiled_async_component->node->meta.exec_mode == wh::compose::node_exec_mode::async);
  ...
  REQUIRE(compiled_passthrough->node->meta.exec_mode == wh::compose::node_exec_mode::sync);
  REQUIRE(compiled_passthrough->node->meta.exec_origin == wh::compose::node_exec_origin::lowered);
  ...
  REQUIRE(compiled_tools->node->meta.exec_mode == wh::compose::node_exec_mode::sync);
  REQUIRE(compiled_tools->node->meta.exec_origin == wh::compose::node_exec_origin::authored);
  ...
  auto async_tools_node = wh::compose::make_tools_node<wh::compose::node_contract::value,
                                                       wh::compose::node_contract::value,
                                                       wh::compose::node_exec_mode::async>(
      "tools-async", std::move(async_registry));
  auto compiled_async_tools = build_single_node_graph(async_tools_node);
  REQUIRE(compiled_async_tools.has_value());
  REQUIRE(compiled_async_tools->node->meta.exec_mode == wh::compose::node_exec_mode::async);
  REQUIRE(compiled_async_tools->node->meta.exec_origin == wh::compose::node_exec_origin::authored);

  auto child_graph = make_streaming_subgraph_graph();
  REQUIRE(child_graph.has_value());
  auto subgraph = wh::compose::make_subgraph_node("child-subgraph", std::move(child_graph).value());
  auto compiled_subgraph = build_single_node_graph(subgraph);
  REQUIRE(compiled_subgraph.has_value());
  REQUIRE(compiled_subgraph->node->meta.exec_mode == wh::compose::node_exec_mode::async);
  REQUIRE(compiled_subgraph->node->meta.exec_origin == wh::compose::node_exec_origin::lowered);
}
...
TEST_CASE("compose component node explicit async mode uses async handlers",
  ...
  struct dual_embedding_impl {
    ...
    [[nodiscard]] auto embed_sender(wh::embedding::embedding_request &&request) const {
      ...
      return stdexec::just(
          wh::core::result<wh::embedding::embedding_response>{wh::embedding::embedding_response{
              std::vector<double>{static_cast<double>(request.inputs.size() + 100U)}}});
    }
  };

  auto shared_counts = std::make_shared<embedding_counts>();
  auto sync_node = wh::compose::make_component_node<wh::compose::component_kind::embedding,
                                                    wh::compose::node_contract::value,
                                                    wh::compose::node_contract::value>(
  ...
  auto sync_output = invoke_single_node_graph(
      sync_node, wh::core::any(wh::embedding::embedding_request{.inputs = {"abc"}}), context);
  REQUIRE(sync_output.has_value());
  auto sync_typed = read_any<wh::embedding::embedding_response>(sync_output.value());
  REQUIRE(sync_typed.has_value());
  REQUIRE(sync_typed.value()[0] == std::vector<double>{1.0});

  auto async_output = invoke_single_node_graph(
      async_node, wh::core::any(wh::embedding::embedding_request{.inputs = {"abc"}}), context);
  REQUIRE(async_output.has_value());
  auto async_typed = read_any<wh::embedding::embedding_response>(async_output.value());
  ...
  auto callback_output = invoke_single_node_graph(
      async_node, wh::core::any(wh::embedding::embedding_request{.inputs = {"abc", "de"}}),
      callback_context);
  REQUIRE(callback_output.has_value());
  auto callback_typed = read_any<wh::embedding::embedding_response>(callback_output.value());
  ...
  auto custom_async = wh::compose::make_component_node<
      ...
      "custom-async", dual_custom_component{custom_shared_counts});
  auto custom_output = invoke_single_node_graph(custom_async, wh::core::any(7), context);
