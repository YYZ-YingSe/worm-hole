...
template <typename scheduler_t,
          typename stop_token_t = stdexec::never_stop_token>
[[nodiscard]] auto make_completion_scheduler_env(
    scheduler_t scheduler, stop_token_t stop_token = {})
...
template <typename launch_scheduler_t, typename completion_scheduler_t,
          typename stop_token_t = stdexec::never_stop_token>
[[nodiscard]] auto make_dual_scheduler_env(
    launch_scheduler_t launch_scheduler,
    completion_scheduler_t completion_scheduler, stop_token_t stop_token = {})
    -> dual_scheduler_env<std::remove_cvref_t<launch_scheduler_t>,
                          std::remove_cvref_t<completion_scheduler_t>,
                          stop_token_t> {
  return {
