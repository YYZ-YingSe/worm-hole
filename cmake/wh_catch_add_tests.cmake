...
#
# Derived from Catch2's CatchAddTests.cmake.
# worm-hole change: zero-runtime-case executables still emit an empty
# *_tests.cmake file so PRE_TEST discovery remains valid for compile-only
# contract targets.
...
function(catch_discover_tests_impl)
  ...
  # Compile-only contract targets are valid even when they expose zero
  # runtime Catch cases. Emit an empty tests file so PRE_TEST discovery stays
  # structurally sound for ctest.
  if(num_tests STREQUAL "0")
    add_command(set ${_TEST_LIST})
